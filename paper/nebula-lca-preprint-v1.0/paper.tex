...
tables, result figures, and SHA-256 manifests are distributed with
version 1.0 of this preprint. The executed API receipts identify Nebula
LCA engine commit \texttt{4c7cb4b69ae6a0647e3e08d048d6c6724cd93ae3}, the
European Commission Environmental Footprint 3.1 reference package
released in July 2022 as implemented in the pinned Nebula LCA method
package, and the exact elementary-flow identities used by the benchmark.
TIDAS interoperability is referenced to public contract commit
...
fabricated in this pre-reservation version.
