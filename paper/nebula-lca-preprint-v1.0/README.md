...
Reserved Zenodo DOI: [10.5281/zenodo.22244134](https://doi.org/10.5281/zenodo.22244134)

The manuscript, Supporting Information, figures, and redistributable benchmark materials are released under the Creative Commons Attribution 4.0 International license (CC BY 4.0). Software remains under the repository's Apache License 2.0. See `LICENSES.md` for the file-level scope.
...
The Zenodo deposit under DOI `10.5281/zenodo.22244134` should include the manuscript PDF, Supporting Information PDF, source bundle, benchmark ZIP, editable figures, comparison tables, `CITATION.cff`, license notice, and `SHA256SUMS.txt`. The PDF, citation metadata, and final file hashes must be rebuilt together whenever any deposited file changes.
